#!/usr/bin/python3
'''
MANTIS Phase 1, D5, Mission Playback Tool (MPT) 
3rd September 2021
Ben Cook - Airspeed Electronics Ltd

This python app loads up drone flight log data and sesson log data from the MANTIS mote and replays both on a map display.
The drone log data must be in the format generated by the LITCHI Android App.
The MANTIS mote log data format is proprietry to Airspeed Electronics Ltd

Revision History:

V1: (3 sept 2021) Initial release
...
class MANTIS_player(object):
    def __init__(self):
        ...
        self.win = pg.GraphicsWindow(title='MANTIS P1D5 Mission Playback Tool')    
        self.win.ci.layout.setContentsMargins(50, 50, 50, 50) # margins around the edge of the window
        self.win.setWindowTitle('MANTIS P1D5 Mission Playback Tool')
...
if __name__ == '__main__':
    ...
    time.sleep(5)   # Delays for 5 seconds. Used for screen recorder to allow time to maximise GUI window.
    map_app.animation()
